...
int main(){
	"====== Resource-Aware TT (MLQ + MLFQ + Banker's) ======\n\n";
	...
	auto p2= make_shared<CC>(1, AA::INTERACTIVE,	8, vector<int>{3, 1});
	auto p3= make_shared<CC>(1, AA::BATCH,		12, vector<int>{4, 2});
